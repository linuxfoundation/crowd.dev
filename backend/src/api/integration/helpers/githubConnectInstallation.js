...
exports.default = async (req, res) => {
    ...
    const payload = await new integrationService_1.default(req).connectGithubInstallation(req.body.installId);
    await req.responseHandler.success(req, res, payload);
};
//# sourceMappingURL=githubConnectInstallation.js.map