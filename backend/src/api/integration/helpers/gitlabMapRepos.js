...
exports.default = async (req, res) => {
    ...
    const payload = await new integrationService_1.default(req).mapGitlabRepos(req.params.id, req.body.mapping, req.body.projectIds);
    await req.responseHandler.success(req, res, payload);
};
//# sourceMappingURL=gitlabMapRepos.js.map