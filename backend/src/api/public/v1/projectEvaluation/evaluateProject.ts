...
3. Not mainly run on GitHub: the closed pull request and issue counts are low relative to the project's age and popularity (stars/forks) above, or the README states the project is a mirror, is read-only, or that issues/PRs are tracked elsewhere — suggesting the project is developed elsewhere and only mirrored here.
