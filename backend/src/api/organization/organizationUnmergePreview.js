...
exports.default = async (req, res) => {
    ...
    const payload = await new organizationService_1.default(req).unmergePreview(req.params.organizationId, req.body.identity, req.body.revertPreviousMerge);
    await req.responseHandler.success(req, res, payload, 200);
};
//# sourceMappingURL=organizationUnmergePreview.js.map