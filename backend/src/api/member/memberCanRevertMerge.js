...
exports.default = async (req, res) => {
    ...
    const payload = await new memberService_1.default(req).canRevertMerge(req.params.memberId, req.query.identityId);
    await req.responseHandler.success(req, res, payload, 200);
};
//# sourceMappingURL=memberCanRevertMerge.js.map