...
exports.default = async (req, res) => {
    ...
    const payload = await new dataIssueService_1.default(req).createDataIssue({ ...req.body, entity: types_1.DataIssueEntity.PERSON }, req.params.id);
    await req.responseHandler.success(req, res, payload);
};
//# sourceMappingURL=memberDataIssueCreate.js.map