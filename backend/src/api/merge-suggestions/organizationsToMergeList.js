...
exports.default = async (req, res) => {
    ...
    const payload = await new organizationService_1.default(req).findOrganizationsWithMergeSuggestions(req.body);
    await req.responseHandler.success(req, res, payload);
};
//# sourceMappingURL=organizationsToMergeList.js.map