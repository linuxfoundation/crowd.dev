...
// Breadth: refresh the current 30-day window for every is_critical npm package, monthly on the 1st.
// Mirrors the count to packages.downloads_last_30d for use by rank_packages().
