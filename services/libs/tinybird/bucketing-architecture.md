...
2. **Insights**: When using the Insights API, bucketId is automatically injected when a `project` parameter is present. No additional bucketId parameter is required - the API handles routing transparently.
